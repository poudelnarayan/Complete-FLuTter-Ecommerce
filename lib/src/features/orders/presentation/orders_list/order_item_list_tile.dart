...
class OrderItemListTile extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return AsyncValueWidget(
      ...
      shimmerWidget: orderShimmerWidget,
    );
  }
}

const Widget orderShimmerWidget = Row(
  mainAxisAlignment: MainAxisAlignment.start,
  crossAxisAlignment: CrossAxisAlignment.start,
  children: [
    BannerPlaceholder(
        height: 120, width: 100.0), // Ensure width is also defined
    ...
    Expanded(
      child: Column(
        ...
        children: [
          ...
          SizedBox(
              height:
                  10), // Adding spacing between TitlePlaceholder and ContentPlaceholder
          SmallcontentPlaceholder(width: 80),
          SizedBox(height: 10), // Adding spacing between ContentPlaceholders
        ],
      ),
    ),
  ],
